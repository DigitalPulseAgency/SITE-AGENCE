    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          ...
          <div className="relative flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
            ...
            <div className="w-10 h-10 md:w-12 md:h-12 relative animate-brain-pulse group-hover:[animation-duration:1.5s]">
              {/* 
                IMPORTANT : Placez uniquement l'icône de votre logo (cerveau.png) sans fond 
                dans le dossier public/ pour un rendu parfait.
              */}
              <img 
                src="/logo.png" 
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
          <button onClick={() => scrollTo('automatisation')} className="hover:text-white transition-colors">Automatisation</button>
